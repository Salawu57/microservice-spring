package com.salawuBabatunde.account.controller;

import com.salawuBabatunde.account.constants.AccountsConstants;
import com.salawuBabatunde.account.dto.CustomerDto;
import com.salawuBabatunde.account.dto.ErrorResponseDto;
import com.salawuBabatunde.account.dto.ResponseDto;
...
public class AccountController {
    ...
    @Operation(
            summary = "Fetching Account Details REST API",
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CustomerDto> fetchAccountDetails(@RequestParam  @Pattern(regexp="(^$|[0-9]{11})",message = "Mobile number must be 10 digits") String mobileNumber){
